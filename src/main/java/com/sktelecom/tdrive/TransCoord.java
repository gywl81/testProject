...
public class TransCoord
{
    ...
    {
    	System.out.println(COORD_BASE[fromType][0]);
    	System.out.println(COORD_BASE[fromType][1]);
    	System.out.println(COORD_BASE[toType][0]);
    	System.out.println(COORD_BASE[toType][1]);
    ...
    {
    	System.out.println(frombx);
    	System.out.println(fromby);
    	System.out.println(tobx);
